...
--   Player ESP • SPEED: 1 to 100 TRILLION
...
-- =============================================
-- SPEED CONTROL — 1 TO 100 TRILLION
-- =============================================
task.spawn(function()
...
-- Speed Input Box — LIMIT: 1 to 100 TRILLION
...
SpeedBox.Text = "16"
SpeedBox.PlaceholderText = "Speed: 1–100,000,000,000,000"
...
local MAX_SPEED = 100000000000000

SpeedBox.FocusLost:Connect(function(EnterPressed)
    local Val = tonumber(SpeedBox.Text)
    if Val then
        Val = math.clamp(Val, 1, MAX_SPEED) -- ✅ HANGGANG 100 TRILLION!
...
print("  SPEED LIMIT: 1 to 100 TRILLION ✅")
print("==========================================")
Notify("Jelo Warfreak", "Speed: 1–100 Trillion Ready!", 4)
